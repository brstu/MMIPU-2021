...
int main() {
    cout << "Linear:\nE\t\tY\t\tU" << endl;
    Linear* m = new Linear(1.03, 0.92);
    Controller* r = new Controller(0.123, 23, 44, 34);
    PID_System(25, r, m, 0);

    cout << "\n\nNon_Linear:\nE\t\tY\t\tU" << endl;
    Non_Linear* nl = new Non_Linear(0.24, 0.11, 0.32, 0.21);
    Controller* nlr = new Controller(0.123, 23, 44, 34);
