 МИНИСТЕРСТВО ОБРАЗОВАНИЯ РЕСПУБЛИКИ БЕЛАРУСЬ
	...
	Задание 1
Содержание файла Modelka_1.mdl (сумма с произведением и разность с частным):
 ![task_01.1](images/task_01.1.png)
Содержание файла Modelka_2.mdl (вычисление суммы ряда               ):
	Задание 2 
Реализовать Реализовать функцию e^x, используя средства Simulink.

![task_01.2](images/task_01.2.png)
...
![task_01_3(cos)](images/task_01_3(cos).png)
...
![task_01_3(cosi)](images/task_01_3(cosi).png)

то слагаемое с номером i+1:

![task_01_3(cos i+1)](images/task_01_3(cos i+1).png)

Используя простые преобразования, можно получить:

![task_01_3(cosres)](images/task_01_3(cosres).png)
...
![task_01.3](images/task_01.3.png)
